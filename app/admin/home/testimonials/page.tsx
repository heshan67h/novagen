...
import { getTestimonials } from '@/app/actions/home';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-gradient-to-br from-[#0f172a] to-[#1e293b] border border-white/10 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <p className="text-slate-400 font-medium mb-1">Total Testimonials</p>
                        <h2 className="text-4xl font-bold text-white tracking-tight">{totalReviews}</h2>
                    </div>
                </div>
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-[#0f172a] to-[#1e293b] border border-white/10 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-slate-400 text-sm">
                            Manage what your clients say about you. Positive reviews build trust and convert visitors into customers.
                        </p>
                    </div>
                </div>
            </div>
