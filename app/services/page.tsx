...
export default function Services() {
  return (
    ...
    >
      ...
      <main
        className="services-main-wrapper"
        style={{
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Snapshot card */}
            <aside
              className="services-snapshot-card"
              style={{
                position: "relative",
                borderRadius: 24,
                padding: 22,
          ...
          >
            <div
              className="services-delivery-grid"
              style={{
                display: "grid",
          ...
          >
            {[0, 1].map((rowIndex) => (
              <div
                className={`services-scenario-grid`}
                key={rowIndex}
                style={{
                  display: "grid",
                  gridTemplateColumns: "minmax(0, 1.7fr) minmax(0, 1.3fr)",
              ...
              >
                {/* Text column */}
                <div
                  className="services-scenario-text"
                  style={{
                ...
                {/* Visual column */}
                <div
                  className="services-scenario-visual"
                  style={{
          ...
          >
            ...
            <div
              className="services-guarantee-grid"
              style={{
                display: "grid",
