...
export default function SocialBar() {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-row justify-between items-center px-4 py-3 md:px-20 md:py-2 bg-gradient-to-r from-[#0a0f23] to-[#16213e] border-t border-white/10 shadow-[0_-4px_20px_rgba(0,0,0,0.4)] text-white text-[13px] md:text-[15px]">
        {/* Left: Contact Info */}
